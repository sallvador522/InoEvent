...
content = content.replace(/<div className="flex justify-between items-center mb-1"><div className="flex justify-between items-center mb-1"><span className="">Link do Mapa \(URL\)<\/span>.*?Procurar no Maps<\/button><\/div>/g, 
...
console.log('Fixed broken links 2!');
